...
class HeliosDisplay {
 ...
 private:
  ...
  uint16_t appliedSleepSeconds_ = 0;
  bool appliedFlipped_ = false;
  bool appliedRearLedEnabled_ = true;
  bool screenSleeping_ = false;
  bool suppressTouchUntilRelease_ = false;
  ...
  uint32_t blockPopupSequence_ = 0;
  ...
  uint32_t lastSleepingTouchPollAt_ = 0;
  uint32_t lastBalanceCheckAt_ = 0;
};
