...
void HeliosDisplay::loop() {
  ...
  if (now - lastTouchPollAt_ >= TOUCH_POLL_MS) {
...
void HeliosDisplay::drawHome(const HeliosMiningStats& stats) {
  ...
  display.fillRoundRect(4, 170, 153, 54, 4, PANEL);
  display.fillRoundRect(163, 170, 153, 54, 4, PANEL);
  drawLabel(12, 176, "BEST DIFFICULTY");
  drawLabel(171, 176, "WEB UI");
...
void HeliosDisplay::drawHomeValues(const HeliosMiningStats& stats) {
  ...
  display.setTextDatum(lgfx::top_left);
  drawValue(12, 195, 137, String(stats.bestDifficulty, 4), WHITE, PANEL);
  display.fillRect(171, 195, 137, 18, PANEL);
  display.setTextDatum(lgfx::top_left);
  ...
  display.drawString(ip, 171, 195, 2);
}
...
void HeliosDisplay::drawCoin(const HeliosCoinProfile& profile,
  ...
  display.fillRoundRect(4, 184, 153, 40, 4, PANEL);
  display.fillRoundRect(163, 184, 153, 40, 4, PANEL);
  drawLabel(12, 188, "SHARES A / R");
  drawLabel(171, 188, "BEST DIFF");
...
void HeliosDisplay::drawCoinValues(const HeliosCoinProfile& profile,
  ...
  drawValue(12, 202, 137,
            mining ? String(stats.acceptedShares) + " / " +
                         String(stats.rejectedShares)
                   : "--",
            WHITE, PANEL);
  drawValue(171, 202, 137,
